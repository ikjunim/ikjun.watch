...
const lsLower = Array.from({length: 26}, (_, i) => String.fromCharCode(97 + i));
const lsUpper = Array.from({length: 26}, (_, i) => String.fromCharCode(65 + i));
const lsNumber = Array.from({length: 10}, (_, i) => String.fromCharCode(48 + i));
const lsOper = ['+', '-', '/'];
